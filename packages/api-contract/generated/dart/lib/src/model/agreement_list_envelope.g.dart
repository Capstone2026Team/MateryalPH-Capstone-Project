...
part of 'agreement_list_envelope.dart';
...
class _$AgreementListEnvelope extends AgreementListEnvelope {
  ...
  factory _$AgreementListEnvelope(
      ...
      (AgreementListEnvelopeBuilder()..update(updates))._build();

  _$AgreementListEnvelope._(
      {required this.data, required this.meta, required this.errors})
      : super._();
  @override
  AgreementListEnvelope rebuild(
          void Function(AgreementListEnvelopeBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AgreementListEnvelopeBuilder toBuilder() =>
      AgreementListEnvelopeBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AgreementListEnvelope &&
        data == other.data &&
        meta == other.meta &&
        errors == other.errors;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AgreementListEnvelope')
          ..add('data', data)
          ..add('meta', meta)
          ..add('errors', errors))
        .toString();
...
class AgreementListEnvelopeBuilder
  ...
  AgreementListEnvelopeBuilder() {
    AgreementListEnvelope._defaults(this);
  }

  AgreementListEnvelopeBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(AgreementListEnvelopeBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AgreementListEnvelope build() => _build();

  _$AgreementListEnvelope _build() {
    _$AgreementListEnvelope _$result;
    try {
      _$result = _$v ??
          _$AgreementListEnvelope._(
            data: data.build(),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AgreementListEnvelope', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
